 ...
 *    Lead is out of CrmObjectType's v1 scope). A contact-tracked Salesforce
...
const STAGE_PROPERTY_BY_OBJECT: Record<CrmObjectType, string> = {
  deal: 'StageName',
  contact: 'Atlas_Stage__c',
};

function objectApiName(object: CrmObjectType): 'Opportunity' | 'Contact' {
...
export const salesforceClient: CrmProvider = {
  ...
  async listProperties(tokens: DecryptedTokens, object: CrmObjectType): Promise<CrmProperty[]> {

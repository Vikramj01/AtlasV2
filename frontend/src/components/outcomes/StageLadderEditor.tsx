...
import type { OutcomeSourceConfig, StageMappingRow, ValueSource } from '@/types/outcomes';
...
export function StageLadderEditor({ config }: StageLadderEditorProps) {
  const { stageMappings, loading, errors, loadStageMappings, saveStageMappings } = useOutcomesStore();
